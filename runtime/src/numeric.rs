...
pub fn checked_f64_to_f32(value: f64) -> Result<f32, NumericError> {
    ...
    if !narrowed.is_finite() || narrowed as f64 != value {
        return Err(NumericError::OutOfRange);
    }
    Ok(narrowed)
}
...
pub fn wrapping_unsigned(value: i64, bits: u32) -> i64 {
    if bits == 64 {
        ...
        ((value as u64) & ((1_u64 << bits) - 1)) as i64
    }
}

pub fn wrapping_add_signed(a: i64, b: i64, bits: u32) -> i64 {
    wrapping_signed(a.wrapping_add(b), bits)
}
pub fn wrapping_sub_signed(a: i64, b: i64, bits: u32) -> i64 {
    wrapping_signed(a.wrapping_sub(b), bits)
}
pub fn wrapping_mul_signed(a: i64, b: i64, bits: u32) -> i64 {
    wrapping_signed(a.wrapping_mul(b), bits)
}
pub fn wrapping_add_unsigned(a: i64, b: i64, bits: u32) -> i64 {
    wrapping_unsigned(a.wrapping_add(b), bits)
}
pub fn wrapping_sub_unsigned(a: i64, b: i64, bits: u32) -> i64 {
    wrapping_unsigned(a.wrapping_sub(b), bits)
}
pub fn wrapping_mul_unsigned(a: i64, b: i64, bits: u32) -> i64 {
    wrapping_unsigned(a.wrapping_mul(b), bits)
}
...
mod tests {
    ...
    #[test]
    fn signed_wraps() {
        assert_eq!(wrapping_add_signed(127, 1, 8), -128);
    }
    #[test]
    fn unsigned_wraps() {
        assert_eq!(wrapping_add_unsigned(255, 1, 8), 0);
    }
    #[test]
    fn checked_rejects() {
        assert!(checked_int_to_int(256, false, 8).is_err());
    }
}
