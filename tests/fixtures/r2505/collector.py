"""Real OTLP/HTTP collector used by the R-2505 PostgreSQL lane.

It accepts only the official protobuf content type and persists raw payloads.
The validator decodes those payloads independently from the Rust exporter.
"""
