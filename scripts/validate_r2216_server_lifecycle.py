...
def validate_implementation() -> None:
    ...
    require("assert_eq!(HOST_CALLS.len(), 165)" in lib, "host-call count must be 165")
    require(
        "assert_eq!(required_host_call_count(), 165)" in runtime,
        "runtime host-call count must be 165",
    )
