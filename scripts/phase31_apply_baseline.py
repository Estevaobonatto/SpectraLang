#!/usr/bin/env python3
"""Apply the median numbers from `target/phase31/stable-report.json` to
...
Usage::
    ...
    python scripts/phase31_apply_baseline.py
    python scripts/phase31_apply_baseline.py --stable target/phase31/stable-report.json
"""
