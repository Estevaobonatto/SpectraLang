...
fn pipeline_handles_malformed_inputs_without_internal_errors() {
    let corpus = [
        ("broken_import.spectra", "module demo; import { println from std.io;"),
        ("broken_return.spectra", "module demo; fn main() -> int { return; }"),
        ("broken_match.spectra", "module demo; fn main() { match 1 { case => {} } }"),
    ];
